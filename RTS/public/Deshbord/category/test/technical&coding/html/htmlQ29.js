const questions = [
  ...
  {
    "num": 2,
    "question_en": "Which HTML tag is used to define the document's head section?",
    "question_hi": "डॉक्यूमेंट के हेड सेक्शन को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 4,
    "question_en": "Which HTML tag is used to define a document title?",
    "question_hi": "डॉक्यूमेंट टाइटल को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 7,
    "question_en": "Which HTML tag is used to define a link to external resources?",
    "question_hi": "एक्सटर्नल रिसोर्सेज के लिए लिंक को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 9,
    "question_en": "Which HTML tag is used to define a script section?",
    "question_hi": "स्क्रिप्ट सेक्शन को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
